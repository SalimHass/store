        ...
        return (
            <div className="cart--hero">
                ...
                <div className="summery--container">
                    ...
                    <p className="summery--tax"> Tax 21%:<span
                        className="summary--numbers">{currency.symbol}{Math.round(sum * 100 * .21) / 100}</span></p>
                    <p className="summery--tax"> Quantity:<span className="summary--numbers">{quantity}</span></p>

                    <p className="summery--tax"> Total:<span
                        className="summary--numbers">{currency.symbol}{Math.round(sum * 100) / 100}</span></p>
